return {
  ...
  config = function()
    ...
    fzf_lua.setup {
      ...
      vim.keymap.set('n', '<leader>fh', fzf_lua.help_tags, { desc = '[S]earch [H]elp' }),
      vim.keymap.set('n', '<leader>fk', fzf_lua.keymaps, { desc = '[S]earch [K]eymaps' }),
      vim.keymap.set('n', '<leader>ff', fzf_lua.files, { desc = '[S]earch [F]iles' }),
      vim.keymap.set('n', '<leader>fw', fzf_lua.live_grep, { desc = '[S]earch current [W]ord' }),
      vim.keymap.set('n', '<leader>fg', fzf_lua.grep_visual, { desc = '[S]earch by [G]rep' }),
      ...
      vim.keymap.set('n', '<leader>fd', fzf_lua.lsp_document_diagnostics, { desc = '[S]earch [D]iagnostics' }),
      vim.keymap.set('n', '<leader>fs', fzf_lua.lsp_document_symbols, { desc = '[S]earch [S]ymbols' }),
