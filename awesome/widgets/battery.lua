...
local function worker(user_args)
	...
	local path_to_icons = args.path_to_icons or "/usr/share/icons/ubuntu-mono-dark/status/22/"
	...
	local batteryType = "unity-battery-good-symbolic"
	...
	watch("acpi -i", timeout, function(widget, stdout)
		...
		if charge >= 1 and charge < 15 then
			batteryType = "unity-battery-empty%s-symbolic"
		...
		elseif charge >= 15 and charge < 40 then
			batteryType = "unity-battery-caution%s-symbolic"
		elseif charge >= 40 and charge < 60 then
			batteryType = "unity-battery-low%s-symbolic"
		elseif charge >= 60 and charge < 80 then
			batteryType = "unity-battery-good%s-symbolic"
		elseif charge >= 80 and charge <= 100 then
			batteryType = "unity-battery-full%s-symbolic"
		end
