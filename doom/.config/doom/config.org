...
;; Direnv gerencia .env e vars de ambiente por diretório
;; Use .envrc nos projetos com: dotenv, source .venv/bin/activate, etc
#+end_src
...
** Python
#+begin_src emacs-lisp
;; +pyvenv no init.el já ativa .venv automaticamente por buffer via pyvenv-track-virtualenv
;; Diretórios de projetos com .venv são detectados automaticamente
;; Para shell/REPL/compile: use direnv com .envrc (direnv module já está ativo no init.el)
#+end_src
