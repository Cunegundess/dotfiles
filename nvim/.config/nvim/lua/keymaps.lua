...
-- Exit terminal mode in the fzf_lua terminal with a shortcut that is a bit easier
...
-- Keeps cursor in place when appeding line below to the current line
vim.keymap.set('n', 'J', 'mzJ`z')

-- Replace the word in the cursor
